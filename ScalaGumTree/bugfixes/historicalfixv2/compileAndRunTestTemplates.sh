...
cd bin
scala -classpath .:../allLibs/*:../allLibs/*/*:gumdiff/handlejdt/*:gumdiff/jdtgum/*:gumdiff/customLib/*:gumdiff/handlecommits/*:gumdiff/difftemplates/* gumdiff.difftemplates.DiffTemplates /home/mau/Research/ReplacementsEmpiricalStudy/GitRepos/react-nativeBugFixingCommitVersions/Commit1/before/ReactTextView.java /home/mau/Research/ReplacementsEmpiricalStudy/GitRepos/react-nativeBugFixingCommitVersions/Commit1/after/ReactTextView.java
